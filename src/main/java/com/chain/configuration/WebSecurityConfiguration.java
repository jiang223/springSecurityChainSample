 ...
 */
package com.chain.configuration;
...
//	}
	...
	public void setFilterChainProxySecurityConfigurer(
			...
			@Value("#{@autowiredAWebSecurityConfigurersIgnoreParents.getWebSecurityConfigurers()}") List<SecurityConfigurer<Filter, WebSecurity>> webSecurityConfigurers)
			throws Exception {
	...
	@Bean
	public static AutowiredWebSecurityConfigurersIgnoreParents autowiredAWebSecurityConfigurersIgnoreParents(
