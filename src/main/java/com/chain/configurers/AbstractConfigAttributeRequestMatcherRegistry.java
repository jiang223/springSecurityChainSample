...
public abstract class AbstractConfigAttributeRequestMatcherRegistry<C> extends
	 ...
	 * {@link #chainRequestMatchers(List)}. May be empty.
	 *
	 * @return the {@link UrlMapping} added by subclasses in
	 * {@link #chainRequestMatchers(List)}
	 */
	 ...
	 * {@link #chainRequestMatchers(List)} and resets the unmapped
	...
	/**
	 * Adds a {@link UrlMapping} added by subclasses in
	 * {@link #chainRequestMatchers(List)} at a particular index.
	 *
