...
import com.chain.annotation.SecurityConfigurerAdapter;
import com.chain.configuration.EnableWebSecurity;
import com.chain.configuration.WebSecurityConfiguration;
import com.chain.configurers.*;
import com.chain.web.DefaultSecurityFilterChain;
...
public final class HttpSecurity extends
	...
	public TestConfigurer<HttpSecurity> test() throws Exception {
		return getOrApply(new TestConfigurer<>());
	}
